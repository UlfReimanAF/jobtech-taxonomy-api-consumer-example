...
> List&lt;Response2992&gt; v0TaxonomyPublicChangesGet(fromDateTime, offset, limit)
...
try {
    List<Response2992> result = apiInstance.v0TaxonomyPublicChangesGet(fromDateTime, offset, limit);
...
[**List&lt;Response2992&gt;**](Response2992.md)
...
> List&lt;Response2994&gt; v0TaxonomyPublicConceptsGet(id, preferredLabel, type, deprecated, offset, limit)
...
Long limit = 789L; // Long | 
try {
    List<Response2994> result = apiInstance.v0TaxonomyPublicConceptsGet(id, preferredLabel, type, deprecated, offset, limit);
    System.out.println(result);
} catch (ApiException e) {
...
[**List&lt;Response2994&gt;**](Response2994.md)
...
> List&lt;Response2996&gt; v0TaxonomyPublicSearchGet(q, type, offset, limit)
...
Long limit = 789L; // Long | 
try {
    List<Response2996> result = apiInstance.v0TaxonomyPublicSearchGet(q, type, offset, limit);
    System.out.println(result);
} catch (ApiException e) {
...
[**List&lt;Response2996&gt;**](Response2996.md)
